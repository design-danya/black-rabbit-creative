 ...
 *
 * The list order is a pre-computed mix: each piece is placed as far as possible
 * from its recent neighbours by dominant hue, brightness, category and series,
 * so neither the All view nor any single filter shows a run of similar-looking
 * work. Adding a piece anywhere is fine; re-run the sequencing if a batch
 * starts to clump.
 */
...
export const illustrations: Illustration[] = [
  ...
  { slug: 'teacup-mermaid', title: 'Teacup Mermaid', alt: 'Illustration of a mermaid bathing in a teacup', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'red-thread', title: 'Red Thread', alt: 'Illustration of a bat and a goth figure joined by a red thread', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'sardine-tin', title: 'Sardine Tin', alt: 'Illustration of mermaids packed into a sardine tin', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'bathtub-mermaid', title: 'Bathtub Mermaid', alt: 'Illustration of a mermaid in a clawfoot tub', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'trick-or-treat', title: 'Trick or Treat', alt: 'Illustration of a ghost with a balloon and bats', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'rust-robot', title: 'Rust Robot', alt: 'Illustration of a jointed robot on a yellow ground', category: 'character', w: 1308, h: 1500 },
  ...
  { slug: 'duet', title: 'Duet', alt: 'Cartoon illustration of Nola the black rabbit singing alongside a bass player', category: 'nola', w: 1080, h: 1380 },
  ...
  { slug: 'rusty-spoons', title: 'Rusty Spoons', alt: 'Illustration of a green figure holding a spoon', category: 'character', w: 1500, h: 1500 },
  { slug: 'diver', title: 'Diver', alt: 'Illustration of a deep-sea diver riding a fish', category: 'creature', w: 1080, h: 1380 },
  ...
  { slug: 'peach', title: 'Peach', alt: 'Illustration of a peach wearing high heels', category: 'character', w: 480, h: 780 },
  ...
  { slug: 'deep-space-octopus', title: 'Deep Space Octopus', alt: 'Illustration of an octopus in an astronaut helmet', category: 'creature', w: 1080, h: 1380 },
  ...
  { slug: 'coupe-mermaid', title: 'Coupe Mermaid', alt: 'Illustration of a mermaid in a cocktail glass', category: 'character', w: 1000, h: 1500 },
  { slug: 'bonewalker', title: 'Bonewalker', alt: 'Illustration of a skeletal wolf under a violet sky', category: 'creature', w: 1080, h: 1380 },
  ...
  { slug: 'winged', title: 'Winged', alt: 'Illustration of a figure wrapped in a great wing', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'hamfaced', title: 'Hamfaced', alt: 'Spot illustration of a ham hock with hand lettering', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'sunset-ghost', title: 'Sunset Ghost', alt: 'Illustration of a woman walking beside a ghost', category: 'character', w: 1500, h: 1500 },
  { slug: 'bee-and-fairy', title: 'Bee & Fairy', alt: 'Illustration of a firefly fairy meeting a bee', category: 'creature', w: 1024, h: 1024 },
  { slug: 'lets-drive-far-away', title: 'Let\'s Drive Far Away', alt: 'Illustration of a vintage red car with hand lettering', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'tentacle-veil', title: 'Tentacle Veil', alt: 'Illustration of a woman with an octopus across her face', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'trombone-bouquet', title: 'Trombone Bouquet', alt: 'Illustration of a trombone spilling flowers', category: 'character', w: 985, h: 1500 },
  ...
  { slug: 'snifter', title: 'Snifter', alt: 'Illustration of a goldfish and octopus inside a brandy glass', category: 'creature', w: 1500, h: 1500 },
  ...
  { slug: 'firefly-fairy', title: 'Firefly Fairy', alt: 'Illustration of a fairy under a full moon', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'ghost-walk', title: 'Ghost Walk', alt: 'Illustration of a sheeted ghost hiking a mountain trail', category: 'character', w: 1500, h: 1500 },
  ...
  { slug: 'shrimp-bed', title: 'Shrimp Bed', alt: 'Illustration of a mermaid curled inside a shrimp', category: 'character', w: 1500, h: 1500 },
]
