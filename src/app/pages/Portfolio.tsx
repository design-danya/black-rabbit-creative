...
const kapiloffLogoNew = "/assets/9f3b646f87bf88255b78b61243df754e1cc4a02a.png";
const basicBalanceThumb = "/assets/c2966b48a7c59fc377cbe7b0bbefc3111f13f42b.png";
const novaDermThumb = "/assets/e70fdcb5ccc84272667c059482c68732ec2f27a7.png";
const hendricksThumb = "/assets/ce45cde349dc30f5f89c11e2c69e3ff0a5d834c7.png";
const cheshireThumb = "/assets/8dc83a7b88b02077a8109e5054207db15a94c7bb.png";
const keenePrideThumb = "/assets/80d637756726e86dd3d855c41a7fac9b5da2473a.png";
const printMaterialsThumb = "/assets/27b429ff9bf6ae77c400a58d4198a2382953e9e5.png";
const sequoiaThumb = "/assets/6a9e50f522155b75baf5e7ef9d9c159116527921.png";
const badgerBalmThumb = "/assets/24b92cae45ca047c0ff92c7910f024424d35b8af.png";
        ...
        <motion.div layout className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-px bg-white/[0.04]">
          <AnimatePresence mode="popLayout">
            {filtered.map((project, i) => (
              ...
              >
                {project.href ? (
                  <Link href={project.href} className="group block relative overflow-hidden aspect-square">
