...
const brandSlides = [
  { src: coverImg.src, alt: "Elm City Brewing — Brand Guidelines Cover | Designed by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: contentsImg.src, alt: "Elm City Brewing — Table of Contents | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: aboutBrandImg.src, alt: "Elm City Brewing — About the Brand | Brand strategy by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: missionImg.src, alt: "Elm City Brewing — Mission, Vision & Purpose | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: valuesImg.src, alt: "Elm City Brewing — Brand Values | Brand strategy by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: personalityImg.src, alt: "Elm City Brewing — Brand Personality & Voice | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: logosIntroImg.src, alt: "Elm City Brewing — Logos & Clear Space | Logo system by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: primaryLogoImg.src, alt: "Elm City Brewing — Primary Logo | Logo design by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: logoProgressionImg.src, alt: "Elm City Brewing — Logo Progression & Design Rationale | Logo design by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: secondaryLogoImg.src, alt: "Elm City Brewing — Secondary Logo | Logo system by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: submarkLogoImg.src, alt: "Elm City Brewing — Submark Logo | Logo system by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: logoMarkImg.src, alt: "Elm City Brewing — Logo Mark | Logo design by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: incorrectUsageImg.src, alt: "Elm City Brewing — Incorrect Logo Usage | Brand guidelines by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: incorrectExamplesImg.src, alt: "Elm City Brewing — Incorrect Usage Examples | Brand guidelines by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: colorPaletteImg.src, alt: "Elm City Brewing — Color Palette | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: colorSwatchesImg.src, alt: "Elm City Brewing — Color Swatches & Specs | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: colorUsageImg.src, alt: "Elm City Brewing — Color Usage Guidelines | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: brandFontsImg.src, alt: "Elm City Brewing — Brand Fonts | Typography by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: fontSpecsImg.src, alt: "Elm City Brewing — Font Specifications | Typography by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: fontApplicationImg.src, alt: "Elm City Brewing — Font Application | Typography by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: fontIncorrectImg.src, alt: "Elm City Brewing — Font Incorrect Usage | Brand guidelines by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: brandAssetsImg.src, alt: "Elm City Brewing — Brand Assets | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: illustrationSystemImg.src, alt: "Elm City Brewing — Illustration System | Brand assets by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: assetUsageImg.src, alt: "Elm City Brewing — Asset Usage | Brand guidelines by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: socialsPhotoImg.src, alt: "Elm City Brewing — Socials & Photography | Social media by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: socialsMockupImg.src, alt: "Elm City Brewing — Social Media Mockups | Social media by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: photoGuideImg.src, alt: "Elm City Brewing — Photography Guidelines | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: brandActionImg.src, alt: "Elm City Brewing — Brand in Action | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: mockupsGridImg.src, alt: "Elm City Brewing — Brand Mockups | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: mockupsGrid2Img.src, alt: "Elm City Brewing — Collateral Mockups | Brand identity by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
  { src: keepMeSafeImg.src, alt: "Elm City Brewing — Keep Me Safe | Brand guide by Black Rabbit Creative, Portsmouth NH, New Hampshire, New England" },
];
